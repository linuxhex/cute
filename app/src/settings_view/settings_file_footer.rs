...
pub fn render_open_settings_file_button(
    ...
    Hoverable::new(mouse_state, move |state| {
        let icon = ConstrainedBox::new(Icon::Code2.to_cuteui_icon(text_fill).finish())
...
pub fn render_settings_error_alert(
    ...
    // `ClippedScrollable` wants `cuteui::elements::Fill` (not the theme
    ...
    let scrollable_text = ConstrainedBox::new(
        ClippedScrollable::vertical(
            ...
            text_row,
            ScrollbarWidth::Auto,
            cuteui::elements::Fill::Solid(coloru_with_opacity(text_color, 30)),
            cuteui::elements::Fill::Solid(coloru_with_opacity(text_color, 60)),
...
fn render_alert_action_button(
    ...
    Hoverable::new(mouse_state, move |state| {
        ...
        if let Some(icon) = icon {
            row.add_child(
                Container::new(
                    ConstrainedBox::new(icon.to_cuteui_icon(Fill::Solid(text_color)).finish())
