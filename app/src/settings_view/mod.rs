...
// use referrals_page::{ReferralsPageEvent, ReferralsPageView}; // Removed: referral feature
...
impl FromStr for SettingsSection {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "WarpDrive" | "Warp Drive" | "Drive" => Ok(Self::WarpDrive),
...
impl SettingsView {
    pub fn new(page: Option<SettingsSection>, ctx: &mut ViewContext<Self>) -> Self {
        ...
        // Build sidebar nav items. Removed account and cloud-related pages for Cute.
        ...
        let initial_page = match page {
            Some(SettingsSection::AI) => SettingsSection::CodeIndexing,
