...
use cuteui::text_layout::{ClipConfig, TextStyle};
...
use crate::local_storage_types::model::actions::{ObjectActionType, ObjectActions};
use crate::local_storage_types::CloudObjectMetadataExt;
...
impl WorkflowsMoreInfoView {
    ...
    fn render_edit_button(
        ...
        render_hoverable_card_button(
            ...
            move |ctx: &mut cuteui::EventContext<'_>, _, _| {
