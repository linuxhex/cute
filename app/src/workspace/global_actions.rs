...
use cuteui::{AppContext, SingletonEntity, TypedActionView};
...
pub fn init_global_actions(app: &mut AppContext) {
    ...
    // Cute: app:maybe_log_out / app:log_out 已删除 - 本地版始终已登录
}
...
// Cute: trigger_maybe_log_out / trigger_log_out 已删除 - 本地版始终已登录
...
// Cute: trigger_log_out 已删除 - 本地版始终已登录
