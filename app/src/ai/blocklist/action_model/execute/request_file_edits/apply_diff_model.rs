...
use cuteui::{Entity, ModelContext, ModelHandle, SingletonEntity as _};
...
impl ApplyDiffModel {
    ...
    pub fn apply_diffs(
        ...
        // RemoteServerManager has been removed; remote file operations are unsupported.
        let _remote_client = session_context.host_id();
