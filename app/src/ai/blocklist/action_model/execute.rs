...
#[cfg(feature = "local_fs")]
use cute_files::{FileModel, TextFileReadResult};
#[cfg(feature = "local_fs")]
use cute_util::file::FileLoadError;
#[cfg(feature = "local_fs")]
use cute_util::file_type::is_buffer_binary;
use cuteui::r#async::{Spawnable, SpawnableOutput};
...
/// Async sibling of [`cute_util::file_type::is_file_content_binary`]. Reads
...
/// module so `cute_util` doesn't need to grow an `async_fs` dependency.
#[cfg(feature = "local_fs")]
