...
pub fn green_check_icon(appearance: &Appearance) -> cuteui::elements::Icon {
...
pub fn red_x_icon(appearance: &Appearance) -> cuteui::elements::Icon {
    cuteui::elements::Icon::new(
        Icon::X.into(),
...
pub fn cancelled_icon(appearance: &Appearance) -> cuteui::elements::Icon {
    cuteui::elements::Icon::new(
        Icon::Cancelled.into(),
...
pub fn reverted_icon(appearance: &Appearance) -> cuteui::elements::Icon {
    cuteui::elements::Icon::new(
