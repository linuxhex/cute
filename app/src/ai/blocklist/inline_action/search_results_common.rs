...
use cuteui::{AppContext, EventContext, SingletonEntity};
...
pub fn render_search_results_header(
    ...
    is_expanded: bool,
    mouse_state: cuteui::elements::MouseStateHandle,
    ...
    cuteui::elements::Hoverable::new(mouse_state, |_| inner)
