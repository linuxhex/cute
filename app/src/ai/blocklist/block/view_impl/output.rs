...
#[allow(unused_imports)]
use cute_util::path::{common_path, CleanPathResult};
...
use cuteui::ui_components::radio_buttons::{RadioButtonItem, RadioButtonLayout};
use cuteui::{
...
fn render_read_skill(
    ...
    // Removed: 'open skill' button for known, non-bundled skills (cloud feature)
...
fn render_read_files(
    ...
    // Removed: skill button (cloud feature)
...
fn render_stopped_output(props: Props, app: &AppContext) -> Box<dyn Element> {
        ...
        && FeatureFlag::AIResumeButton.is_enabled()
    {
        ...
        let play_icon = Container::new(
            ConstrainedBox::new(Icon::Play.to_cuteui_icon(theme.foreground()).finish())
        ...
        let resume_button = cuteui::ui_components::button::Button::new(
...
fn render_references_footer(
    ...
    let title_row = Flex::row()
        ...
        .with_child(
            ConstrainedBox::new(chevron.to_cuteui_icon(title_row_color).finish())
...
fn render_collapsible_header(
    ...
    let expandable = Hoverable::new(toggle_mouse_state, move |_is_hovered| {
        Flex::row()
            ...
            .with_child(
                Container::new(
                    ConstrainedBox::new(chevron_icon.to_cuteui_icon(text_color.into()).finish())
