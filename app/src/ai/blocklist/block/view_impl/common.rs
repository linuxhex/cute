...
use cute_util::path::to_relative_path;
...
use cuteui::image_cache::{CacheOption, ImageType};
use cuteui::keymap::Keystroke;
use cuteui::platform::Cursor;
use cuteui::text_layout::{ClipConfig, TextAlignment, TextStyle};
use cuteui::ui_components::button::Button;
use cuteui::ui_components::components::{Coords, UiComponent, UiComponentStyles};
use cuteui::{Action, AppContext, Element, EventContext, SingletonEntity, View, ViewHandle};
...
fn render_queue_next_prompt_button(
    ...
    let icon = Container::new(
        ConstrainedBox::new(Icon::ClockPlus.to_cuteui_icon(icon_color).finish())
            .with_height(icon_size)
            .with_width(icon_size)
            .finish(),
    )
...
fn render_visual_markdown_block<A: Action>(
    ...
    let content = if let Some(tooltip) = options.tooltip.clone() {
        ...
        appearance.ui_builder().tool_tip_on_element(
            ...
            mouse_state,
            content,
            cuteui::elements::ParentAnchor::TopMiddle,
            cuteui::elements::ChildAnchor::BottomMiddle,
...
fn render_visual_card(
    ...
    let header_icon = ConstrainedBox::new(icon.to_cuteui_icon(header_text_color.into()).finish())
        .with_width(16.)
        .with_height(16.)
        .finish();
...
fn render_table_section(
    ...
    let table_element = Table::new(table_handles.state_handle.clone(), 0.0, 0.0)
        ...
        .with_config(TableConfig {
            ...
            row_background: cuteui::elements::RowBackground {
...
struct TableCellProps {
    ...
    font_family: cuteui::fonts::FamilyId,
    font_size: f32,
    font_weight: Weight,
    text_color: ColorU,
...
fn render_invalid_api_key_error(
    ...
    let settings_button = appearance
        .ui_builder()
        .button(
            cuteui::ui_components::button::ButtonVariant::Outlined,
            state_handle.clone(),
        )
...
pub(crate) fn render_debug_footer<V: View>(
    ...
    let submit_button = if !is_dogfood && !is_enterprise_user {
        ...
        Some(
            appearance
                .ui_builder()
                .button(
                    cuteui::ui_components::button::ButtonVariant::Text,
    ...
    let copy_button_with_tooltip = appearance.ui_builder().tool_tip_on_element(
        ...
        copy_button,
        cuteui::elements::ParentAnchor::TopRight,
        cuteui::elements::ChildAnchor::BottomRight,
        vec2f(0., -8.),
    );
