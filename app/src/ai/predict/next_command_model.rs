...
use cute_completer::meta::Spanned;
use cute_completer::parsers::hir::{Command, Expression, FlagType};
use cute_completer::parsers::ParsedExpression;
...
pub fn is_next_command_enabled(app: &cuteui::AppContext) -> bool {
