...
use cute_core::ui::appearance::{Appearance, AppearanceEvent};
...
impl RuleView {
    ...
    pub fn add_ai_rule(
        ...
        //     });
        // }
        log::warn!("云端创建规则功能已禁用 - 无法创建 AI 规则");
    }
    ...
    pub fn edit_ai_rule(
        ...
        // });
        log::warn!("云端编辑规则功能已禁用 - 无法编辑 AI 规则");
    }
    ...
    pub fn delete_ai_rule(&mut self, id: SyncId, ctx: &mut ViewContext<Self>) {
        ...
        //     );
        // });
        log::warn!("云端删除规则功能已禁用 - 无法删除 AI 规则");
    }
        ...
        Hoverable::new(mouse_state, move |state| {
            ...
            if is_selected {
                container = container
                    ...
                    .with_corner_radius(CornerRadius::with_all(cuteui::elements::Radius::Pixels(
                        4.,
                    )));
    ...
    fn render_disabled_banner(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        .with_corner_radius(CornerRadius::with_all(cuteui::elements::Radius::Pixels(4.)))
