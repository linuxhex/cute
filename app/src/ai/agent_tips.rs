...
static DEFAULT_TIPS: LazyLock<Vec<AgentTip>> = LazyLock::new(|| {
    vec![
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/capabilities/slash-commands".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/terminal/input/universal-input#input-modes".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/capabilities/planning".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
        },
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/terminal/command-palette".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/local-agents/agent-context/using-to-add-context".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/local-agents/agent-context/blocks-as-context#attaching-blocks-as-context".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/capabilities/codebase-context".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/capabilities/agent-profiles-permissions".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/local-agents/interacting-with-agents/conversation-forking".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/terminal/blocks/block-actions#copy-input-output-of-block".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/local-agents/agent-context/images-as-context".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/capabilities/full-terminal-use".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/code/code-review".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/capabilities/mcp".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/reference/cli/integration-setup".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        ...
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/capabilities/rules".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        ...
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/local-agents/interacting-with-agents".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
        },
        ...
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/reference/cli".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        ...
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/capabilities/rules#project-rules-1".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/local-agents/agent-context/urls-as-context".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        AgentTip {
            description: "Cutefy a remote SSH session to enable Oz inside that environment.".to_string(),
            link: Some("https://docs.cute.dev/terminal/cutefy".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        ...
        AgentTip {
            ...
            link: Some("https://docs.cute.dev/agent-platform/capabilities/full-terminal-use#session-level-approvals".to_string()),
        ...
        && AISettings::as_ref(ctx).is_voice_input_enabled(ctx)
    {
        tips.push(AgentTip {
            description: "Hold <keybinding> to speak your prompt directly to the agent."
                .to_string(),
            link: Some(
                "https://docs.cute.dev/agent-platform/local-agents/interacting-with-agents/voice"
                    .to_string(),
            ),
