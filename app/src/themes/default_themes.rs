...
use cute_core::ui::color::{coloru_with_opacity, OPAQUE};
use cute_core::ui::theme::color::CustomDetails;
use cute_core::ui::theme::{
    AnsiColor, AnsiColors, Details, Fill, HorizontalGradient, Image, TerminalColors,
    VerticalGradient, CuteTheme,
};
...
pub(super) fn dracula() -> CuteTheme {
    CuteTheme::new(
...
pub(super) fn solarized_light() -> CuteTheme {
    CuteTheme::new(
...
pub(super) fn solarized_dark() -> CuteTheme {
    CuteTheme::new(
...
pub(super) fn gruvbox_dark() -> CuteTheme {
    CuteTheme::new(
...
pub(super) fn gruvbox_light() -> CuteTheme {
    CuteTheme::new(
...
pub(super) fn cyber_wave() -> CuteTheme {
    CuteTheme::new(
...
pub(super) fn willow_dream() -> CuteTheme {
    CuteTheme::new(
        Fill::VerticalGradient(VerticalGradient::new(
...
pub(super) fn fancy_dracula() -> CuteTheme {
    CuteTheme::new(
        Fill::VerticalGradient(VerticalGradient::new(
...
pub(super) fn phenomenon() -> CuteTheme {
    CuteTheme::new(
...
pub(super) fn jellyfish() -> CuteTheme {
    CuteTheme::new(
...
pub(super) fn pink_city() -> CuteTheme {
...
pub(super) fn red_rock() -> CuteTheme {
    CuteTheme::new(
        Fill::VerticalGradient(VerticalGradient::new(
...
pub(super) fn dark_city() -> CuteTheme {
    CuteTheme::new(
        Fill::VerticalGradient(VerticalGradient::new(
...
pub(super) fn sent_referral_reward() -> CuteTheme {
    CuteTheme::new(
        ...
        Some("Cute Referral".to_string()),
    )
}

pub(super) fn solar_flare() -> CuteTheme {
    CuteTheme::new(
...
pub(super) fn adeberry() -> CuteTheme {
    CuteTheme::new(
...
pub(super) fn received_referral_reward() -> CuteTheme {
    CuteTheme::new(
