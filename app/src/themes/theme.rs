...
pub use cute_core::ui::color::blend::Blend;
use cute_core::ui::color::pick_foreground_color;
pub use cute_core::ui::theme::*;
...
impl std::fmt::Display for ThemeKind {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let value = match &self {
            ...
            ThemeKind::SentReferralReward => "Cute Referral",
            ThemeKind::ReceivedReferralReward => "Referred to Cute",
...
pub fn render_preview(
    ...
    if let Some(background_image) = theme.background_image() {
        thumbnail.add_child(
            Shrinkable::new(
                1.,
                cuteui::elements::Image::new(
                    background_image.source(),
                    cuteui::elements::CacheOption::BySize,
                )
                .cover()
                .finish(),
            )
