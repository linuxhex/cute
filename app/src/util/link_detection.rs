...
use cuteui::elements::{MouseStateHandle, PartialClickableElement};
use cuteui::platform::Cursor;
use cuteui::text::char_slice;
use cuteui::Action;
                    ...
                    if let DetectedLinkType::FilePath { absolute_path, .. } = &path_type {
                        for (line_number, char_range) in line_ranges {
                            ...
                            let line_range_link = DetectedLinkType::FilePath {
                                ...
                                line_and_column_num: Some(cute_util::path::LineAndColumnArg {
...
pub(crate) fn get_word_range_at_offset(
    ...
    use cute_editor::content::buffer::{ToBufferCharOffset, ToBufferPoint};
    use cuteui::text::words::is_default_word_boundary;
