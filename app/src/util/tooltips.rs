...
use cuteui::{AppContext, Element, EventContext};
    ...
    OnClick: 'static + Fn(&mut EventContext),
{
    ...
    // Cloud enterprise secret redaction removed for local version
    let is_enterprise_secret_redaction_enabled = false;
...
pub fn should_show_open_in_warp_link(path: &Path, app: &AppContext) -> bool {
    ...
    use crate::local_storage_types::is_markdown_file;
