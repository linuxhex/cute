...
use cuteui::{Action, AppContext, SingletonEntity};
...
pub enum CustomAction {
    ...
    SelectBlockBelow,
    SelectAllBlocks,
    // Cute: CreateBlockPermalink removed - cloud feature
    ToggleBookmarkBlock,
    FindWithinBlock,
    CopyBlock,
    CopyBlockCommand,
...
pub fn custom_tag_to_keystroke(custom: CustomTag) -> Option<Keystroke> {
    match custom.into() {
        ...
        // Cute: CreateBlockPermalink binding removed - cloud feature
...
/// [`cuteui::keymap::FixedBinding`] or [`EditableBinding`].
