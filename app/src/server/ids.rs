// Re-export types from cute_server_client.
#[allow(unused_imports)]
pub use cute_server_client::ids::GenericStringObjectId;
pub use cute_server_client::ids::{
...
/// For types defined in cute_server_client, use `cute_server_client::server_id_traits!` instead.
#[macro_export]
