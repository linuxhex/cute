...
impl TeamClient for ServerApi {
    ...
    async fn create_team(
        ...
        // Note: entrypoint parameter removed - using default
        let variables = CreateTeamVariables {
            input: CreateTeamInput {
                name,
                entrypoint: warp_graphql::mutations::create_team::CloudObjectEventEntrypoint::Unknown,
    ...
    async fn remove_user_from_team(
        ...
        let variables = RemoveUserFromTeamVariables {
            input: RemoveUserFromTeamInput {
                ...
                team_uid: team_uid.into(),
                entrypoint: warp_graphql::mutations::remove_user_from_team::CloudObjectEventEntrypoint::Unknown,
            },
            request_context: get_request_context(),
        };
