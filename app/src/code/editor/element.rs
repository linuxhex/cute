...
use cute_editor::editor::EditorView;
use cute_editor::render::element::lens_element::RichTextElementLens;
use cute_editor::render::element::{RenderableBlock, RichTextElement, VerticalExpansionBehavior};
    ...
    fn render_gutter_button(
        ...
        let mut button = Hoverable::new(mouse_state, |state| {
            ...
            let container = Container::new(
                ConstrainedBox::new(
                    cuteui::elements::Icon::new(gutter_button.icon().into(), icon_color).finish(),
                )
        ...
        if enabled {
            button = button.with_cursor(cuteui::platform::Cursor::PointingHand);
