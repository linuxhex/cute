use cute_completer::completer::{CommandOutput, GeneratorContext};
...
fn parse_dynamic_command(output: &CommandOutput) -> anyhow::Result<Vec<String>> {
    match output.status {
        cute_completer::completer::CommandExitStatus::Success => {
        ...
        cute_completer::completer::CommandExitStatus::Failure => {
