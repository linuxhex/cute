...
use cute_core::semantic_selection::{SemanticSelection, SMART_SELECT_MATCH_WINDOW_LIMIT};
use cute_core::{safe_assert, safe_assert_eq};
use cute_terminal::model::grid::{CellType, FlatStorage};
pub use cute_terminal::model::TermMode;
...
impl GridHandler {
    ...
    pub(super) fn input_at_cursor(&mut self, text: &str) {
        use cute_terminal::model::VisiblePoint;
