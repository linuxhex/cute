...
use crate::settings::{
    AISettings, DebugSettings, EnforceMinimumContrast, TerminalSpacing,
};
...
impl BlockListElement {
    ...
    fn render_selection(
        ...
        color: ColorU,
        _selection_cursor_render_location: SelectionCursorRenderLocation,
        ctx: &mut PaintContext,
    ) {
        ...
        while let Some((visible_idx, block_entry)) = items_iter.next() {
            ...
            match block_entry {
                VisibleItem::Block {
                    ...
                    // Current block is selected by ourselves
