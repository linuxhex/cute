...
use cuteui::elements::{resizable_state_handle, ResizableStateHandle};
use cuteui::{Entity, SingletonEntity, WindowId};
...
impl ModalSizes {
    ...
    pub fn get_resizable_state_handle(&self, modal: ModalType) -> ResizableStateHandle {
        match modal {
            ...
            ModalType::CuteDriveIndexWidth => resizable_state_handle(0.0),  // CuteDriveIndexWidth disabled
        }
    }
}
