...
pub const SSH_DOCS_URL: &str = "https://docs.warp.dev/terminal/cuteify/ssh";
pub const SUBSHELL_DOCS_URL: &str = "https://docs.warp.dev/terminal/cuteify/subshells";
...
pub fn render_never_cuteify_ssh_link(
    ssh_host: &Option<String>,
    app: &AppContext,
    appearance: &Appearance,
    mouse_state_handle: MouseStateHandle,
    on_never_cuteify: fn(&mut EventContext<'_>, ssh_host: String),
    ...
    let link = appearance
        ...
        .link(
            ...
            Some(Box::new({
                ...
                move |ctx| on_never_cuteify(ctx, ssh_host.to_owned())
            })),
            mouse_state_handle,
        )
        .soft_wrap(false)
...
pub fn render_subshell_flag_pole(
    max_height: f32,
    fill: impl Into<cuteui::elements::Fill>,
) -> Box<dyn Element> {
