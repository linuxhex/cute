...
use crate::themes::theme::{AnsiColorIdentifier, ThemeKind, CuteThemeConfig};
...
impl RootView {
    ...
    fn debug_enter_onboarding_state(&mut self, _: &(), _ctx: &mut ViewContext<Self>) -> bool {
        ...
        // TODO: Reimplement this method after removing deprecated AuthOnboardingState variants
        log::warn!("debug_enter_onboarding_state is temporarily disabled");
        false
    }
