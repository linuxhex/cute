...
pub struct ChannelConfig {
    ...
    /// Configuration for talking to Cute's servers.
    pub server_config: CuteServerConfig,
...
#[derive(Debug, Deserialize, Serialize)]
pub struct CuteServerConfig {
    /// The root URL for the standard server pool.
    pub server_root_url: Cow<'static, str>,
    /// The URL for the RTC server, which serves real-time updates for Cute Drive objects.
...
impl CuteServerConfig {
    pub fn production() -> Self {
        Self {
            server_root_url: "https://app.cute.dev".into(),
            rtc_server_url: "wss://rtc.app.cute.dev/graphql/v2".into(),
            session_sharing_server_url: Some("wss://sessions.app.cute.dev".into()),
...
pub struct OzConfig {
    ...
    /// to [`CuteServerConfig::server_root_url`]. This exists so the audience is not overridden
...
impl OzConfig {
    pub fn production() -> Self {
        Self {
            oz_root_url: "https://oz.cute.dev".into(),
