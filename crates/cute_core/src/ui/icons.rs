...
/// Icon enum to be used within the app in place of the cuteui::elements::Icon directly. It
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::CuteDrive => "bundled/svg/cute.svg",
            Icon::Cute => "bundled/svg/cute-drive.svg",
            Icon::CuteLogoLight => "bundled/svg/cute-logo-light.svg",
            ...
            Icon::Cuteing0 => "bundled/svg/cute-loading-0.svg",
            Icon::Cuteing1 => "bundled/svg/cute-loading-1.svg",
            Icon::Cuteing2 => "bundled/svg/cute-loading-2.svg",
            Icon::Cuteing3 => "bundled/svg/cute-loading-3.svg",
            Icon::Cuteing4 => "bundled/svg/cute-loading-4.svg",
            Icon::Cuteing5 => "bundled/svg/cute-loading-5.svg",
            Icon::Cuteing6 => "bundled/svg/cute-loading-6.svg",
            Icon::Cuteing7 => "bundled/svg/cute-loading-7.svg",
            Icon::Cuteing8 => "bundled/svg/cute-loading-8.svg",
            Icon::Cuteing9 => "bundled/svg/cute-loading-9.svg",
            Icon::Cuteing10 => "bundled/svg/cute-loading-10.svg",
            Icon::Cuteing11 => "bundled/svg/cute-loading-11.svg",
...
impl Icon {
    pub fn to_cuteui_icon(self, color: Fill) -> CuteUiIcon {
        CuteUiIcon::new(self.into(), color.into_solid())
    }

    pub fn icon_for_key(key: &str) -> Option<CuteUiIcon> {
        match key {
            "⏎" => Some(Self::CornerDownLeft.to_cuteui_icon(Fill::black())),
            _ => None,
        }
    }
}
