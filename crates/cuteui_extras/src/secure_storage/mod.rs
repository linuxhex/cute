...
/// A type alias for the concrete type stored within a cuteui
/// app context, enabling usage such as:
///
/// ```
/// use cuteui::{App, SingletonEntity};
/// use cuteui_extras::secure_storage;
///
...
/// common scheme is reverse-DNS notation (e.g.: "dev.cute.Cute").
#[cfg(not(target_os = "windows"))]
pub fn register(service_name: &str, ctx: &mut cuteui::AppContext) {
...
pub fn register_noop(service_name: &str, ctx: &mut cuteui::AppContext) {
...
impl cuteui::Entity for Model {
    type Event = ();
}

impl cuteui::SingletonEntity for Model {}
...
impl AppContextExt for cuteui::AppContext {
    fn secure_storage(&self) -> &dyn SecureStorage {
