...
/// The main Cute process spawns this via the `ripgrep-search` CLI
...
mod process_impl {
    ...
    /// Spawns the cute CLI with the `ripgrep-search` subcommand.
    fn spawn_search_process(
        ...
        cmd.arg(cute_cli::ripgrep_search_subcommand())
            .arg(cute_cli::parent_flag());
