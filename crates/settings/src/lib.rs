...
use cute_features::FeatureFlag;
use cuteui::{AppContext, Entity, ModelContext};
...
impl PublicPreferences {
    ...
    pub fn reload_from_disk(&self) -> Result<(), cuteui_extras::user_preferences::Error> {
        self.0.reload_from_disk()
    }
}

impl cuteui::Entity for PublicPreferences {
    type Event = ();
}

impl cuteui::SingletonEntity for PublicPreferences {}
...
impl cuteui::Entity for PrivatePreferences {
    type Event = ();
}

impl cuteui::SingletonEntity for PrivatePreferences {}
...
pub trait Setting {
    ...
    /// Returns whether and how this setting is synced to the cloud via Cute Drive.
    ...
    fn set_value_from_cloud_sync(
        &mut self,
        new_value: Self::Value,
        ctx: &mut cuteui::ModelContext<Self::Group>,
    ) -> anyhow::Result<()>;
