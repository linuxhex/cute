...
use cuteui_core::rendering::{GPUBackend, GPUDeviceInfo, GPUDeviceType};
use wgpu::{
...
lazy_static! {
    ...
    /// 22.1.2, in practice, Cute windows don't render properly until 24.0.2.
...
/// Returns whether or not the provided adapter is an unsupported Nvidia driver version for cuteui
/// to render properly.
...
/// https://linear.app/cutedotdev/issue/CORE-3692/background-images-broken-in-parallels
...
/// cuteui to render properly. Currently, we limit this to "Intel UHD Graphics 620", but we do have
...
/// alignment.
///
/// See: https://github.com/cutedotdev/Cute/issues/6120
pub fn adapter_has_rendering_offset_bug(adapter_info: &wgpu::AdapterInfo) -> bool {
    ...
    // https://github.com/cutedotdev/Cute/issues/6120.
    let affected_models = [
...
/// https://github.com/cutedotdev/cute/issues/10618
/// https://github.com/cutedotdev/cute/issues/4879
...
/// (Vulkan llvmpipe) adapter that may not work properly with cuteui.
...
fn adapter_stability_sort_func(
    ...
    // Same with Nvidia drivers, though this is only an issue with a Wayland window server.
        ...
        log::warn!(
            ...
            https://docs.cute.dev/help/known-issues#linux-1",
...
enum AdapterSupport {
    ...
    /// The adapter is basically not viable. Cuteui will either crash or not render.
    Unsupported = 2,
}
