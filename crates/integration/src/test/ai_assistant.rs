...
use cute::integration_testing::view_getters::ai_assistant_panel_view;
use cuteui::async_assert;

use super::new_builder;
use crate::Builder;

/// Checks if the Ask Cute AI keybinding works correctly when a block is selected.
/// This is a regression test: https://linear.app/cutedotdev/issue/WAR-6758/cute-ai-ask-from-block-keybinding-doesnt-work-as-expected.
pub fn test_ask_cute_ai_keybinding_for_selected_block() -> Builder {
    new_builder()
