...
use cute::integration_testing::code_review::{
...
use cute::integration_testing::view_getters::{single_terminal_view_for_tab, workspace_view};
use cute::workspace::WorkspaceAction;
use cuteui::integration::{AssertionCallback, TestStep};
use cuteui::{async_assert, App, WindowId};
...
fn code_review_scroll_anchor_builder(
    ...
    new_builder()
        ...
        .with_setup(|utils| {
            ...
            run_git(&repo_dir, &["config", "user.name", "Cute Integration Test"]);
