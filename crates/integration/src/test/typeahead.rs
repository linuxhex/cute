use cute::integration_testing::agent_mode::AgentViewState;
...
use cute::terminal::shell::{Shell, ShellType};
...
/// Tests that the shell reports its input buffer to the Cute typeahead model after
...
pub fn test_background_output() -> Builder {
    ...
    use regex::Regex;
    use cute::integration_testing::block::assert_background_output;
    use cute::integration_testing::terminal::execute_command_for_single_terminal_in_tab;
