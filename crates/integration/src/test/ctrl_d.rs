...
use cute::integration_testing::view_getters::assert_no_views_of_type;
use cute::pane_group::PaneGroup;
use cute::terminal::model::bootstrap::BootstrapStage;
use cute::terminal::shell::ShellType;
use cute::terminal::TerminalView;
...
pub fn test_ctrl_d_handled_by_read_during_bootstrapping() -> Builder {
    new_builder()
        .set_should_run_test(|| {
            ...
            // We need to fix https://github.com/cutedotdev/Cute/issues/1869 before
