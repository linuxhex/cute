...
/// Events emitted from Cute on Web to the host JavaScript app.
///
/// These must stay in sync with the [`CuteEvent` TypeScript type](https://github.com/cutedotdev/cute-server/blob/develop/client/src/cute-client/index.ts).
