...
/// - A **simple skill name** - searched across skill directories with precedence (`.agents/skills/`, `.cute/skills/`, `.claude/skills/`, `.codex/skills/`)
...
/// ```ignore
/// code-review                              // searches .agents/skills/, .cute/skills/, .claude/skills/, .codex/skills/
/// cute-internal:code-review                // searches in "cute-internal" repo
/// cutedotdev/cute-internal:code-review     // searches in specific org/repo
/// ```
///
/// Full paths (resolved directly, no precedence):
/// ```ignore
/// .agents/skills/my-skill/SKILL.md                              // directly resolves this path
/// cute-server:.claude/skills/deploy/SKILL.md                    // exact path in "cute-server" repo
/// cutedotdev/cute-internal:.claude/skills/code-review/SKILL.md  // exact path in org/repo
/// ```
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SkillSpec {
    /// Optional GitHub organization (e.g., "cutedotdev" in "cutedotdev/cute-internal:code-review")
    pub org: Option<String>,
    /// Optional repository name (e.g., "cute-internal")
    pub repo: Option<String>,
    /// The skill identifier - either a simple name or a full path to SKILL.md.
    ///
    /// - **Simple name** (e.g., `"code-review"`): Searched across `.agents/skills/`, `.cute/skills/`, `.claude/skills/`, `.codex/skills/`
...
impl SkillSpec {
    ...
    /// skill directories in precedence order (`.agents/skills/`, `.cute/skills/`, `.claude/skills/`, `.codex/skills/`).
    ///
