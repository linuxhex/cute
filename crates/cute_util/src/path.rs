//! This module contains utilities for dealing with file/directory paths throughout Cute.
use std::borrow::Cow;
...
pub fn cute_shell_path() -> Option<String> {
...
/// https://github.com/cutedotdev/cute-internal/pull/13955
...
/// ```
/// use std::path::Path;
/// use cute_util::path::common_path;
///
...
/// use cute_util::path::group_roots_by_common_ancestor;
///
