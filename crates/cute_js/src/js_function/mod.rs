...
/// types.
///
/// `I` is the type of the function's input, which must implement `IntoCuteJs` and be
/// deserializable.
/// `O` is the type of the function's return value, which must implement `FromCuteJs` and be
/// serializable.
