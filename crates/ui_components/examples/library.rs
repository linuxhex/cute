...
use cuteui::elements::Stack;
use cuteui::image_cache::ImageType;
use cuteui::keymap::FixedBinding;
use cuteui::prelude::*;
use cuteui::{AssetProvider, SingletonEntity, Tracked, platform};
...
fn main() -> cuteui::platform::app::TerminationResult {
    ...
    app_builder.run(move |ctx| {
        ...
        let font_family = cuteui::fonts::Cache::handle(ctx).update(ctx, |cache, _ctx| {
        ...
        ctx.add_window(cuteui::AddWindowOptions::default(), RootView::new);
    })
}
...
impl View for RootView {
    ...
    fn keymap_context(&self, _: &AppContext) -> cuteui::keymap::Context {
        ...
        tooltip::Tooltip.render(
            ...
            tooltip::Params {
                ...
                options: tooltip::Options {
                    keyboard_shortcut: Some(cuteui::keymap::Keystroke {
                        ctrl: true,
                        key: "k".to_string(),
                        ..Default::default()
                    }),
                ...
                self.default_button_row.default.render(
                    ...
                    button::Params {
                        ...
                        options: button::Options {
                            keystroke: Some(cuteui::keymap::Keystroke {
                                ctrl: true,
                                key: "k".to_string(),
                                ..Default::default()
                            }),
        ...
        self.dialog.render(
            ...
            dialog::Params {
                ...
                options: dialog::Options {
                    ...
                    dismiss_keystroke: Some(cuteui::keymap::Keystroke {
                        key: "escape".to_string(),
                        ..Default::default()
                    }),
