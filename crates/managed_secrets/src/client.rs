...
use vec1::Vec1;
use cute_graphql::managed_secrets::{ManagedSecret, ManagedSecretConfig, ManagedSecretType};
pub use cute_graphql::queries::task_secrets::ManagedSecretValue;
...
pub trait ManagedSecretsClient: 'static + Send + Sync {
    ...
    async fn list_harness_auth_secrets(
        &self,
        harness: cute_graphql::ai::AgentHarness,
