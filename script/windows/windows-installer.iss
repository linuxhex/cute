...
SetupIconFile="..\..\app\channels\{#ReleaseChannel}\icon\with-white-border\icon.ico"
...
Source: "..\..\app\channels\{#ReleaseChannel}\icon\with-white-border\icon.ico"; DestDir: "{app}"; Flags: ignoreversion
